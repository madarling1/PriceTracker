# PriceTracker
<img width="350" height="280" alt="image" src="https://github.com/user-attachments/assets/40f82838-3621-48c4-b01e-2d7c7b6903de" />


#### 마비노기 모바일의 영혼석, 마력석, 세공기의 거래소 시세를 모니터링합니다.<br>
#### https://mabimobi.life/market 에서 제공중인 API를 이용하여<br>시세 정보를 서버에 기록하고 해당 데이터를 받아옵니다.<br>

# 다운로드
1. [Releases](../../releases)를 엽니다.
2. PriceTracker.exe를 다운로드 합니다.
3. 다운로드한 'PriceTracker.exe'를 실행합니다.
